...
namespace PeopleApp
{
    class PeopleApp
    {
        static void Main(string[] args)
        {
            ...
            // create and initialize our courses
                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                foreach(string courseCode in student.courseCodes)
                                {
                                    ...
                                    Console.Write($"{course.schedule.startTime:hh:mmtt} - {course.schedule.endTime:hh:mmtt}\n");

                                    //IGME-201 - Description for IGME-201 Sunday Monday Wednesday Friday 07:00AM - 07:50AM
                                }
                            }
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    Console.Write("Enter course number (enter nothing to continue): ");
                    sCourses = Console.ReadLine();
                    thisStudent.courseCodes.Add(sCourses);
                }
                while (!sCourses.Equals(""));
            }
