...
namespace Will_UnitTest1_1
{
    //Class: Program
    //Author: Nick Will (modified David Schuh's MathQuiz)
    //Purpose: Demonstrate division and rounding in the MathQuiz program
    //Restrictions: None
    static class Program
    {
        //Method: Main
        //Purpose: A math quiz program with division and rounding added
        //Restrictions: None
        static void Main()
        {
            // store user name
        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                else
                {
                    ...
                    Console.WriteLine($"Answer is {nAnswer}");
                }
