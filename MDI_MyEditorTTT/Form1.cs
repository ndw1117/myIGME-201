...
namespace MyEditor
{
    public partial class Form1 : Form
    {
        ...
        private void BoldToolStripMenuItem__Click(object sender, EventArgs e)
        {
            ...
            {
                selectionFont = richTextBox.Font; //will set all text in selection to defualt font and make bold
            }
        ...
        private void ItalicsToolStripMenuItem__Click(object sender, EventArgs e)
        {
            ...
            if (selectionFont == null) //it will be null if there were multiple fonts in selection
            {
                selectionFont = richTextBox.Font; //will set all text in selection to defualt font and make italic
            }
        ...
        private void UnderlineToolStripMenuItem__Click(object sender, EventArgs e)
        {
            ...
            if (selectionFont == null) //it will be null if there were multiple fonts in selection
            {
                selectionFont = richTextBox.Font; //will set all text in selection to defualt font and make underlined
            }
