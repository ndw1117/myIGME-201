...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            else if (person.eGender == genderPronoun.them || person.name == null)
            {
            ...
            */
            ...
            RadioButton freshRadioButton = new RadioButton();
            freshRadioButton.Text = "Freshman";
