...
//DISCLAIMER: This is a slightly modified versioin of David Schuh's MathQuizFinalCode

//Class: Program
//Author: Nick Will
//Purpose: Demonstrate the use of a timer in a math quiz application
//Restrictions: None
static class Program
{
    //Method: Main
    //Purpose: Uses a timer in a math quiz for the user
    //Restrictions: None
    static void Main()
    {
        // store user name
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            // if response == answer and timer isn't up, output flashy reward and increment # correct
