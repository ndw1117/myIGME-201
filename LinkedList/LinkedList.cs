    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            //LinkedListNode<object> linkedListNode;
            string sentence;
            sentence = "Because I'm sad Clap along if you feel like a room without a roof Because I'm sad Clap along if you feel like sadness is the truth sad";
            ...
            // 4. Your code here
            foreach (LinkedListNode<object> linkedListNode in linkedList)
            {
                if (((string)linkedListNode.Value).Equals("sad"))
                {
                    linkedListNode.Value = "happy";
                }
                else if (((string)linkedListNode.Value).Equals("happiness"))
                {
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.Remove(linkedListNode1.Value);
            linkedList.AddBefore(linkedListNode2, linkedListNode1.Value);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.Remove(linkedListNode1.Value);
            anagram.AddBefore(linkedListNode2, linkedListNode1.Value);
